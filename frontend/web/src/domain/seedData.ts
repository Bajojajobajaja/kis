...
export const seedData: Record<string, EntityRecord[]> = {
  ...
  'crm-sales/cars': [
    ...
    row('CAR-1004', 'Volkswagen Tiguan 2022', 'Demo crossover', 'active', {
      ...
      color: 'Blue',
      ownerClient: 'OOO Avtopark',
      note: 'Dealer demo unit',
    }),
    row('CAR-1005', 'BMW X5 2020', 'Premium SUV', 'active', {
      ...
      color: 'Black',
      ownerClient: 'Ivan Petrov',
      note: 'Corporate lease',
    }),
    row('CAR-1006', 'Skoda Octavia 2018', 'Fleet sedan', 'in_service', {
      ...
      color: 'White',
      ownerClient: 'AO TekhTrans',
      note: 'High mileage, maintenance ongoing',
    }),
    row('CAR-1007', 'Lada Vesta 2021', 'Rental unit', 'active', {
      vin: 'XTA1234567V890123',
      brand: 'Lada',
      model: 'Vesta',
      year: '2021',
      plateNumber: 'G654LM77',
      mileage: '34000',
      color: 'Silver',
      ownerClient: 'OOO Avtopark',
      note: 'Short-term rental fleet',
    }),
  ],
  'service/orders': [
